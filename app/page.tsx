...
const BUBBLES = [
  { size: 16, left: '8%',  delay: 0,   duration: 9,  drift: 18,  color: 'bg-brand-red/60' },
  { size: 10, left: '18%', delay: 2.2, duration: 11, drift: -14, color: 'bg-brand-blue/55' },
  { size: 22, left: '30%', delay: 0.8, duration: 13, drift: 10,  color: 'bg-brand-red/40' },
  { size: 8,  left: '42%', delay: 5.5, duration: 8,  drift: 12,  color: 'bg-brand-red2/55' },
  { size: 13, left: '52%', delay: 3.5, duration: 10, drift: -20, color: 'bg-brand-red2/50' },
  { size: 18, left: '64%', delay: 1.4, duration: 12, drift: 16,  color: 'bg-brand-blue/45' },
  { size: 9,  left: '74%', delay: 4.2, duration: 8,  drift: -10, color: 'bg-brand-red/55' },
  { size: 24, left: '85%', delay: 1.9, duration: 14, drift: 12,  color: 'bg-brand-red/35' },
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <div className="flex flex-col gap-3 max-w-xs mx-auto">
            <motion.button
              ...
              style={{ boxShadow: '0 0 40px rgba(139,0,0,0.3)' }}>
